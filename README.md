# Waning effectiveness of COVID-19 vaccines in people with and without cancer: an OpenSAFELY cohort study using linked electronic health records

The aim of this study was to compare the rates of waning effectiveness of two doses of COVID-29 vaccine in people with and without current cancer
...
* `data_eligible_ab`
  * Runs [`data_eligible_ab.R`](analysis/preprocess/data_eligible_ab.R) to apply eligibility criteria from boxes A and B in Figure 1 of the protocol.
* `data_2nd_vax_dates`
...
* `data_eligible_cde`
  * Runs [`data_eligible_cde.R`](analysis/preprocess/data_eligible_cde.R) to apply eligibility criteria from boxes C, D and E in Figure 1 of the protocol.
* `generate_covs_data`
